...
index_window.geometry("1290x700+0+0")
index_window.maxsize(width=1290, height=660)

# background
backgroundImage = PhotoImage(file="D:\\Flight-Booking-System-Using-Python-and-MySQL\\SourceCode\\indexBg.png")
