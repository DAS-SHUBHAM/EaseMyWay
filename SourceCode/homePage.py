...
home_window.geometry("1280x670+0+0")
home_window.maxsize(width=1280,height=670)

# background
backgroundImage = PhotoImage(file="D:\\Flight-Booking-System-Using-Python-and-MySQL\\SourceCode\\mainPageBg.png")
