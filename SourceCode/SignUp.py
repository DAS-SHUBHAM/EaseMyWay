...
signup_window.geometry("1300x680+0+0")
signup_window.maxsize(width=1300,height=680)

# background
backgroundImage = PhotoImage(file="D:\\Flight-Booking-System-Using-Python-and-MySQL\\SourceCode\\registrationBg.png")
...
def signup_user():
    if usernameEntry.get() == "Username" or usernameEntry.get() == "" or emailEntry.get() == "Email" or \
            emailEntry.get() == "" or passwordEntry.get() == "Password" or confirmEntry.get() == "Confirm Password" or \
            confirmEntry.get() == "":
...
confirmEntry = Entry(signup_window, font=('Comic Sans MS', 12), bd=0, fg="gray7", bg="light cyan", width=31)
confirmEntry.place(x=486, y=477)
confirmEntry.insert(0, "Confirm Password")
confirmEntry.bind('<FocusIn>', confirm_pass_enter)
